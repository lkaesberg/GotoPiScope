...
alt_encoder_motor = EncoderMotor(alt_motor, channel_A=11, channel_B=7, P = 20, steps_rotation=alt_steps_per_rotation)
az_encoder_motor = EncoderMotor(az_motor, channel_A=15, channel_B=14, P = 20, steps_rotation=az_steps_per_rotation)
